...
def main():
    ...
    # load pretrain
        ...
        load_pretrain(model, '../tools/snapshot/checkpoint00_e30.pth')
        #model.backbone.load_state_dict(torch.load(backbone_path+'alexnet.pth'))

   # torch.save({'epoch': 0,'state_dict': model.state_dict(),'optimizer': optimizer.state_dict()},cfg.TRAIN.SNAPSHOT_DIR+'/checkpoint00_e%d.pth' % (0))
